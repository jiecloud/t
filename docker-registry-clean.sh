...
# Modified  by jie.wan@daocloud.io
# Usage: ./dcs-gc-registry.sh <options> <arguments>
...
#    -d     Enable debug mode
# Example:
#    ./dcs-gc-registry.sh -h "http://127.0.0.1" -a "admin:password"
#    ./dcs-gc-registry.sh -h "http://127.0.0.1" -a "admin:password" -p "count=5" -d
#    ./dcs-gc-registry.sh -h "http://127.0.0.1" -a "admin:password" -p "days=7"
#    ./dcs-gc-registry.sh --help
...
{
    # docker api default number is 100, so change it to 2048 or bigger
    #?n=2048--added by jie.wan@daocloud.io
    url="${REGISTRY_HOST}/v2/_catalog?n=2048" 
...
#Clean cache--added by jie.wan@daocloud.io
docker exec -it dce_registry_1 registry garbage-collect /etc/docker/registry/conf.yml
